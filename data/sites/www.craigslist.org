...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/clnew.css?v=494835119e1e390ff13c28a77813439f">
	<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/leaflet-stock.css?v=b2c42652dfbf260e1c45eccc44bdd156">
	<!--[if lte IE 8]>
		<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/leaflet.ie.css?v=33b7852c258da83cb3b844af1cb14270">
	<![endif]-->
	<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/MarkerCluster.css?v=2145c86eef214f53a14667e2e9f29f40">
	<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/MarkerCluster.Default.css?v=32034ed5e13448e0f9b02c81f072f507">
	<!--[if IE]>
		<link type="text/css" rel="stylesheet" media="all" href="//www.craigslist.org/styles/MarkerCluster.Default.ie.css?v=f6fe2df07deb36d38f280d4caf23453c">
	<![endif]-->
	<!--[if lt IE 9]>
<script type="text/javascript" src="//www.craigslist.org/js/html5shiv.js?v=ed7af45dcbda983c8455631037ebcdda"></script>
<![endif]-->
</head>
		...
		<section class="body">
			...
			<div class="colmask">
				...
				<div class="box box_2">
					...
					<h4>Kentucky</h4>
					<ul>
						<li><a href="http://bgky.craigslist.org">bowling green</a></li>
					...
					<h4>Louisiana</h4>
					<ul>
						<li><a href="http://batonrouge.craigslist.org">baton rouge</a></li>
					...
					<h4>Maine</h4>
					<ul>
						<li><a href="http://maine.craigslist.org">maine</a></li>
					</ul>
					<h4>Maryland</h4>
					<ul>
						<li><a href="http://annapolis.craigslist.org">annapolis</a></li>
					...
					<h4>Michigan</h4>
					<ul>
						<li><a href="http://annarbor.craigslist.org">ann arbor</a></li>
					...
					<h4>Minnesota</h4>
					<ul>
						<li><a href="http://bemidji.craigslist.org">bemidji</a></li>
					...
					<h4>Mississippi</h4>
					<ul>
						<li><a href="http://gulfport.craigslist.org">gulfport / biloxi</a></li>
					...
					<h4>Missouri</h4>
					<ul>
						<li><a href="http://columbiamo.craigslist.org">columbia / jeff city</a></li>
				...
				<div class="box box_3">
					...
					<h4>Nebraska</h4>
					<ul>
						<li><a href="http://grandisland.craigslist.org">grand island</a></li>
					...
					<h4>Nevada</h4>
					<ul>
						<li><a href="http://elko.craigslist.org">elko</a></li>
						<li><a href="http://lasvegas.craigslist.org">las vegas</a></li>
						<li><a href="http://reno.craigslist.org">reno / tahoe</a></li>
					</ul>
					<h4>New Hampshire</h4>
					<ul>
						<li><a href="http://nh.craigslist.org">new hampshire</a></li>
					</ul>
					<h4>New Jersey</h4>
					<ul>
						<li><a href="http://cnj.craigslist.org">central NJ</a></li>
					...
					<h4>New Mexico</h4>
					<ul>
						<li><a href="http://albuquerque.craigslist.org">albuquerque</a></li>
					...
					<h4>New York</h4>
					<ul>
						<li><a href="http://albany.craigslist.org">albany</a></li>
					...
					<ul>
						<li><a href="http://asheville.craigslist.org">asheville</a></li>
					...
					<h4>North Dakota</h4>
					<ul>
						<li><a href="http://bismarck.craigslist.org">bismarck</a></li>
					...
					<h4>Ohio</h4>
					<ul>
						<li><a href="http://akroncanton.craigslist.org">akron / canton</a></li>
					...
					<h4>Oklahoma</h4>
					<ul>
						<li><a href="http://lawton.craigslist.org">lawton</a></li>
					...
					<h4>Oregon</h4>
					<ul>
						<li><a href="http://bend.craigslist.org">bend</a></li>
					...
					<h4>Pennsylvania</h4>
					<ul>
						<li><a href="http://altoona.craigslist.org">altoona-johnstown</a></li>
				...
				<div class="box box_4">
					<h4>Rhode Island</h4>
					<ul>
						<li><a href="http://providence.craigslist.org">rhode island</a></li>
					</ul>
					<h4>South Carolina</h4>
					<ul>
						<li><a href="http://charleston.craigslist.org">charleston</a></li>
					...
					<h4>South Dakota</h4>
					<ul>
						<li><a href="http://nesd.craigslist.org">northeast SD</a></li>
					...
					<h4>Tennessee</h4>
					<ul>
						<li><a href="http://chattanooga.craigslist.org">chattanooga</a></li>
					...
					<h4>Texas</h4>
					<ul>
						<li><a href="http://abilene.craigslist.org">abilene</a></li>
					...
					<h4>Utah</h4>
					<ul>
						<li><a href="http://logan.craigslist.org">logan</a></li>
					...
					<h4>Vermont</h4>
					<ul>
						<li><a href="http://burlington.craigslist.org">vermont</a></li>
					</ul>
					<h4>Virginia</h4>
					<ul>
						<li><a href="http://charlottesville.craigslist.org">charlottesville</a></li>
					...
					<h4>Washington</h4>
					<ul>
						<li><a href="http://bellingham.craigslist.org">bellingham</a></li>
					...
					<h4>West Virginia</h4>
					<ul>
						<li><a href="http://charlestonwv.craigslist.org">charleston </a></li>
					...
					<h4>Wisconsin</h4>
					<ul>
						<li><a href="http://appleton.craigslist.org">appleton-oshkosh-FDL</a></li>
					...
					<h4>Wyoming</h4>
					<ul>
							<li><a href="http://wyoming.craigslist.org">wyoming</a></li>
					</ul>


					<h4>Territories</h4>
					<ul>
							<li><a href="http://micronesia.craigslist.org">guam-micronesia</a></li>
							<li><a href="http://puertorico.craigslist.org">puerto rico</a></li>
							<li><a href="http://virgin.craigslist.org">U.S. virgin islands</a></li>
					</ul>
				</div>
			</div>

			<h1><a name="CA"></a>Canada</h1>
			<div class="colmask">
				<div class="box box_1">
					<h4>Alberta</h4>
					<ul>
				...
				<div class="box box_2">
					<h4>Manitoba</h4>
					<ul>
						<li><a href="http://winnipeg.craigslist.ca">winnipeg</a></li>
					</ul>
					<h4>New Brunswick</h4>
					<ul>
						<li><a href="http://newbrunswick.craigslist.ca">new brunswick</a></li>
					</ul>
					<h4>Newfoundland and Labrador</h4>
					<ul>
						<li><a href="http://newfoundland.craigslist.ca">st john's</a></li>
					</ul>
					<h4>Northwest Territories</h4>
					<ul>
						<li><a href="http://territories.craigslist.ca">territories</a></li>
						<li><a href="http://yellowknife.craigslist.ca">yellowknife</a></li>
					</ul>
					<h4>Nova Scotia</h4>
					<ul>
						<li><a href="http://halifax.craigslist.ca">halifax</a></li>
					</ul>
				</div>
				<div class="box box_3">
					<h4>Ontario</h4>
					<ul>
						<li><a href="http://barrie.craigslist.ca">barrie</a></li>
				...
				<div class="box box_4">
					...
					<ul>
						<li><a href="http://pei.craigslist.ca">prince edward island</a></li>
					</ul>
					<h4>Quebec</h4>
					<ul>
						<li><a href="http://montreal.craigslist.ca">montreal</a></li>
					...
					<h4>Saskatchewan</h4>
					<ul>
						<li><a href="http://regina.craigslist.ca">regina</a></li>
						<li><a href="http://saskatoon.craigslist.ca">saskatoon</a></li>
					</ul>
					<h4>Yukon Territory</h4>
					<ul>
						<li><a href="http://whitehorse.craigslist.ca">whitehorse</a></li>
					</ul>
				</div>
			</div>

			<h1><a name="EU"></a>Europe</h1>
			<div class="colmask">
				<div class="box box_1">
					<h4>Austria</h4>
					<ul>
						<li><a href="http://vienna.craigslist.at">vienna</a></li>
					</ul>
					<h4>Belgium</h4>
					<ul>
						<li><a href="http://brussels.craigslist.org">belgium</a></li>
					</ul>
					<h4>Bulgaria</h4>
					<ul>
						<li><a href="http://bulgaria.craigslist.org">bulgaria</a></li>
					</ul>
					<h4>Croatia</h4>
					<ul>
						<li><a href="http://zagreb.craigslist.org">croatia</a></li>
					</ul>
					<h4>Czech Republic</h4>
					<ul>
						<li><a href="http://prague.craigslist.cz">prague</a></li>
					</ul>
					<h4>Denmark</h4>
					<ul>
						<li><a href="http://copenhagen.craigslist.org">copenhagen</a></li>
					</ul>
					<h4>Finland</h4>
					<ul>
						<li><a href="http://helsinki.craigslist.fi">finland</a></li>
					</ul>
					<h4>France</h4>
					<ul>
						<li><a href="http://bordeaux.craigslist.org">bordeaux</a></li>
				...
				<div class="box box_2">
					<h4>Germany</h4>
					<ul>
						<li><a href="http://berlin.craigslist.de">berlin</a></li>
					...
					<h4>Greece</h4>
					<ul>
						<li><a href="http://athens.craigslist.gr">greece</a></li>
					</ul>
					<h4>Hungary</h4>
					<ul>
						<li><a href="http://budapest.craigslist.org">budapest</a></li>
					</ul>
					<h4>Iceland</h4>
					<ul>
						<li><a href="http://reykjavik.craigslist.org">reykjavik</a></li>
					</ul>
					<h4>Ireland</h4>
					<ul>
						<li><a href="http://dublin.craigslist.org">dublin</a></li>
					</ul>
					<h4>Italy</h4>
					<ul>
						<li><a href="http://bologna.craigslist.it">bologna</a></li>
				...
				<div class="box box_3">
					<h4>Luxembourg</h4>
					<ul>
						<li><a href="http://luxembourg.craigslist.org">luxembourg</a></li>
					</ul>
					<h4>Netherlands</h4>
					<ul>
						<li><a href="http://amsterdam.craigslist.org">amsterdam / randstad</a></li>
					</ul>
					<h4>Norway</h4>
					<ul>
						<li><a href="http://oslo.craigslist.org">norway</a></li>
					</ul>
					<h4>Poland</h4>
					<ul>
						<li><a href="http://warsaw.craigslist.pl">poland</a></li>
					</ul>
					<h4>Portugal</h4>
					<ul>
						<li><a href="http://faro.craigslist.pt">faro / algarve</a></li>
						<li><a href="http://lisbon.craigslist.pt">lisbon</a></li>
						<li><a href="http://porto.craigslist.pt">porto</a></li>
					</ul>
					<h4>Romania</h4>
					<ul>
						<li><a href="http://bucharest.craigslist.org">romania</a></li>
					</ul>
					<h4>Russian Federation</h4>
					<ul>
						<li><a href="http://moscow.craigslist.org">moscow</a></li>
						<li><a href="http://stpetersburg.craigslist.org">st petersburg</a></li>
					</ul>
					<h4>Spain</h4>
					<ul>
						<li><a href="http://alicante.craigslist.es">alicante</a></li>
				...
				<div class="box box_4">
					<h4>Sweden</h4>
					<ul>
						<li><a href="http://stockholm.craigslist.se">sweden</a></li>
					</ul>
					<h4>Switzerland</h4>
					<ul>
						<li><a href="http://basel.craigslist.ch">basel</a></li>
					...
					<h4>Turkey</h4>
					<ul>
						<li><a href="http://istanbul.craigslist.com.tr">turkey</a></li>
					</ul>
					<h4>Ukraine</h4>
					<ul>
						<li><a href="http://ukraine.craigslist.org">ukraine</a></li>
					</ul>
					<h4>United Kingdom</h4>
					<ul>
						<li><a href="http://aberdeen.craigslist.co.uk">aberdeen</a></li>
			...
			<h1><a name="ASIA"></a>Asia, Pacific and Middle East</h1>
			<div class="colmask">
				<div class="box box_1">
					<h4>Bangladesh</h4>
					<ul>
						<li><a href="http://bangladesh.craigslist.org">bangladesh</a></li>
					</ul>
					<h4>China</h4>
					<ul>
						<li><a href="http://beijing.craigslist.com.cn">beijing</a></li>
					...
					<h4>Hong Kong</h4>
					<ul>
						<li><a href="http://hongkong.craigslist.hk">hong kong</a></li>
					</ul>
				</div>
				<div class="box box_2">
					<h4>India</h4>
					<ul>
						<li><a href="http://ahmedabad.craigslist.co.in">ahmedabad</a></li>
					...
					<h4>Indonesia</h4>
					<ul>
						<li><a href="http://jakarta.craigslist.org">indonesia</a></li>
					</ul>
					<h4>Iran</h4>
					<ul>
						<li><a href="http://tehran.craigslist.org">iran</a></li>
					</ul>
					<h4>Iraq</h4>
					<ul>
						<li><a href="http://baghdad.craigslist.org">iraq</a></li>
					</ul>
					<h4>Israel and Palestine</h4>
					<ul>
						<li><a href="http://haifa.craigslist.org">haifa</a></li>
				...
				<div class="box box_3">
					<h4>Japan</h4>
					<ul>
						<li><a href="http://fukuoka.craigslist.jp">fukuoka</a></li>
					...
					<h4>Korea</h4>
					<ul>
						<li><a href="http://seoul.craigslist.co.kr">seoul</a></li>
					</ul>
					<h4>Kuwait</h4>
					<ul>
						<li><a href="http://kuwait.craigslist.org">kuwait</a></li>
					</ul>
					<h4>Lebanon</h4>
					<ul>
						<li><a href="http://beirut.craigslist.org">beirut, lebanon</a></li>
					</ul>
					<h4>Malaysia</h4>
					<ul>
						<li><a href="http://malaysia.craigslist.org">malaysia</a></li>
					</ul>
					<h4>Pakistan</h4>
					<ul>
						<li><a href="http://pakistan.craigslist.org">pakistan</a></li>
					</ul>
				</div>
				<div class="box box_4">
					<h4>Philippines</h4>
					<ul>
						<li><a href="http://bacolod.craigslist.com.ph">bacolod</a></li>
					...
					<h4>Singapore</h4>
					<ul>
						<li><a href="http://singapore.craigslist.com.sg">singapore</a></li>
					</ul>
					<h4>Taiwan</h4>
					<ul>
						<li><a href="http://taipei.craigslist.com.tw">taiwan</a></li>
					</ul>
					<h4>Thailand</h4>
					<ul>
						<li><a href="http://bangkok.craigslist.co.th">thailand</a></li>
					</ul>
					<h4>United Arab Emirates</h4>
					<ul>
						<li><a href="http://dubai.craigslist.org">united arab emirates</a></li>
					</ul>
					<h4>Vietnam</h4>
					<ul>
						<li><a href="http://vietnam.craigslist.org">vietnam</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="colmask">
				<div class="box box_1">
					<h4>Australia</h4>
					<ul>
						<li><a href="http://adelaide.craigslist.com.au">adelaide</a></li>
				...
				<div class="box box_2">
					<h4>New Zealand</h4>
					<ul>
						<li><a href="http://auckland.craigslist.org">auckland</a></li>
			...
			<div class="colmask">
				<div class="box box_1">
					<h4>Argentina</h4>
					<ul>
						<li><a href="http://buenosaires.craigslist.org">buenos aires</a></li>
					</ul>
					<h4>Bolivia</h4>
					<ul>
						<li><a href="http://lapaz.craigslist.org">bolivia</a></li>
					</ul>
					<h4>Brazil</h4>
					<ul>
						<li><a href="http://belohorizonte.craigslist.org">belo horizonte</a></li>
					...
					<ul>
						<li><a href="http://caribbean.craigslist.org">caribbean islands</a></li>
					</ul>
				</div>
				<div class="box box_2">
					<h4>Chile</h4>
					<ul>
						<li><a href="http://santiago.craigslist.org">chile</a></li>
					</ul>
					<h4>Colombia</h4>
					<ul>
						<li><a href="http://colombia.craigslist.org">colombia</a></li>
					</ul>
					<h4>Costa Rica</h4>
					<ul>
						<li><a href="http://costarica.craigslist.org">costa rica</a></li>
					</ul>
					<h4>Dominican Republic</h4>
					<ul>
						<li><a href="http://santodomingo.craigslist.org">dominican republic</a></li>
					</ul>
					<h4>Ecuador</h4>
					<ul>
						<li><a href="http://quito.craigslist.org">ecuador</a></li>
					</ul>
					<h4>El Salvador</h4>
					<ul>
						<li><a href="http://elsalvador.craigslist.org">el salvador</a></li>
					</ul>
				</div>
				<div class="box box_3">
					<h4>Guatemala</h4>
					<ul>
						<li><a href="http://guatemala.craigslist.org">guatemala</a></li>
					</ul>
					<h4>Mexico</h4>
					<ul>
						<li><a href="http://acapulco.craigslist.com.mx">acapulco</a></li>
					...
					<h4>Nicaragua</h4>
					<ul>
						<li><a href="http://managua.craigslist.org">nicaragua</a></li>
					</ul>
				</div>
				<div class="box box_4">
					<h4>Panama</h4>
					<ul>
						<li><a href="http://panama.craigslist.org">panama</a></li>
					</ul>
					<h4>Peru</h4>
					<ul>
						<li><a href="http://lima.craigslist.org">peru</a></li>
					</ul>
					<h4>Puerto Rico</h4>
					<ul>
						<li><a href="http://puertorico.craigslist.org">puerto rico</a></li>
					...
					<h4>Uruguay</h4>
					<ul>
						<li><a href="http://montevideo.craigslist.org">montevideo</a></li>
					</ul>
					<h4>Venezuela</h4>
					<ul>
						<li><a href="http://caracas.craigslist.org">venezuela</a></li>
					</ul>
					<h4>Virgin Islands, U.S.</h4>
					<ul>
						<li><a href="http://virgin.craigslist.org">virgin islands</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="colmask">
				<div class="box box_1">
					<h4>Egypt</h4>
					<ul>
						<li><a href="http://cairo.craigslist.org">egypt</a></li>
					</ul>
					<h4>Ethiopia</h4>
					<ul>
						<li><a href="http://addisababa.craigslist.org">ethiopia</a></li>
					</ul>
				</div>
				<div class="box box_2">
					<h4>Ghana</h4>
					<ul>
						<li><a href="http://accra.craigslist.org">ghana</a></li>
					</ul>
					<h4>Kenya</h4>
					<ul>
						<li><a href="http://kenya.craigslist.org">kenya</a></li>
					</ul>
				</div>
				<div class="box box_3">
					<h4>Morocco</h4>
					<ul>
						<li><a href="http://casablanca.craigslist.org">morocco</a></li>
					</ul>
					<h4>South Africa</h4>
					<ul>
						<li><a href="http://capetown.craigslist.co.za">cape town</a></li>
				...
				<div class="box box_4">
					<h4>Tunisia</h4>
					<ul>
						<li><a href="http://tunis.craigslist.org">tunisia</a></li>
					</ul>
				</div>
			</div>
		</section>
...
<footer>
	...
	<script type="text/javascript" src="//www.craigslist.org/js/jquery-1.9.1.js?v=56eaef3b8a28d9d45bb4f86004b0eaae"></script>
	<script type="text/javascript" src="//www.craigslist.org/js/sites_page_maps.js?v=f3b6fb992e61ce21fcda7661147e7bbe"></script>
	<script type="text/javascript" src="//www.craigslist.org/js/formats.js?v=9a0d01febbe8fb4d1d73973839e28b6a"></script>
	<script type="text/javascript" src="//www.craigslist.org/js/leaflet-cl.js?v=66e3693c01b674246830caf4453c1997"></script>
	<script type="text/javascript" src="//www.craigslist.org/js/leaflet.markercluster.js?v=8014f04025cf9767e5ccefd1fce25ba0"></script>
</body>
</html>
